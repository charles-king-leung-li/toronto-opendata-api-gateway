package com.toronto.opendata.gateway.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI torontoOpenDataAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Toronto Open Data API Gateway")
                        .description("Public API Gateway for accessing Toronto Open Data resources via microservices")
                        .version("2.0.0")
                        .contact(new Contact()
